...
<Documents>
  <Document>
    <Path>@.codex/memories/secrets.md</Path>
  </Document>
  <Document>
    <Path>@.codex/memories/monorepo-discipline.md</Path>
  </Document>
  <Document>
    <Path>@.codex/memories/domain-driven.md</Path>
  </Document>
  <Document>
    <Path>@.codex/memories/orpc-patterns.md</Path>
  </Document>
</Documents>
